...
<script type="text/javascript">
  ...
  function hitung_totalgaji(){
    ...
    if(isNaN(parseInt(document.getElementById("total_gaji_jam3").value = gajiku3.toFixed(0)))) tgj3 = 0;
    ...
    if(isNaN(parseInt(document.getElementById("total_gaji_jam3").value = (gajiku3/qt3).toFixed(0)))) tgo3 = 0;
