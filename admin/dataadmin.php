          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <table class="table table-bordered table-striped">
                ...
                <?php
                  $no = 1;
                  $query2 = mysql_query("SELECT * FROM admin WHERE level_admin = 'admin' ORDER BY username ASC");
                ...
                <tr>
                  ...
                  <td><center><a href="editadmin?username=<?php echo $x2['username'];?>" class="btn btn-warning"><i class="fa fa-edit"></i></a></center></td>
...
$('.trash').click(function(){
    ...
    $('#modal-delete').attr('href','hapusadmin.php?username='+id);
})
</script>
</body>
</html>
