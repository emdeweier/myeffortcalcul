        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" <?php if($data['username'] == 'emdeweier') echo 'src="../dist/img/favicon-96x96.png"'; else echo 'src="../dist/img/user.png"'; ?> alt="User profile picture">

              <h3 class="profile-username text-center"><?php if($data['nama_admin'] == '') echo $data['username']; else echo $data['nama_admin']; ?></h3>

              <p class="text-muted text-center"><?php if($data['jabatan'] == '') echo "Tidak Ada Jabatan"; else echo $data['jabatan']; ?></p>
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="settings">
                <form class="form-horizontal" action="profil_db" method="post">
