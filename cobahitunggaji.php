...
$query1 = mysql_query("SELECT * FROM gaji,temp_proyek WHERE gaji.id_temp = temp_proyek.id_temp AND gaji.id_temp = '$id'");
...
<script type="text/javascript">
  ...
  function hitung_totalgaji(){
    var perjam = parseFloat(document.getElementById("total_er_perjam").value);
    ...
    if(isNaN(parseInt(document.getElementById("gaji_jam1").value))) g1 = 0;
    else g1 = parseFloat(document.getElementById("gaji_jam1").value);
    if(isNaN(parseInt(document.getElementById("gaji_jam2").value))) g2 = 0;
    else g2 = parseFloat(document.getElementById("gaji_jam2").value);
    if(isNaN(parseInt(document.getElementById("gaji_jam3").value))) g3 = 0;
    else g3 = parseFloat(document.getElementById("gaji_jam3").value);

    if(isNaN(parseInt(document.getElementById("qty1").value))) qt1 = 0;
    else qt1 = parseFloat(document.getElementById("qty1").value);
    if(isNaN(parseInt(document.getElementById("qty2").value))) qt2 = 0;
    else qt2 = parseFloat(document.getElementById("qty2").value);
    if(isNaN(parseInt(document.getElementById("qty3").value))) qt3 = 0;
    else qt3 = parseFloat(document.getElementById("qty3").value);

    if(isNaN(parseInt(document.getElementById("totaljam_minggu1").value))) tm1 = 0;
    else tm1 = parseFloat(document.getElementById("totaljam_minggu1").value);
    if(isNaN(parseInt(document.getElementById("totaljam_minggu2").value))) tm2 = 0;
    else tm2 = parseFloat(document.getElementById("totaljam_minggu2").value);
    if(isNaN(parseInt(document.getElementById("totaljam_minggu3").value))) tm3 = 0;
    else tm3 = parseFloat(document.getElementById("totaljam_minggu3").value);
    gajiku1 = totalgaji*g1*tm1;
    gajiku2 = totalgaji*g2*tm2;
    gajiku3 = totalgaji*g3*tm3;

    if(isNaN(parseInt(document.getElementById("total_gaji_jam1").value = gajiku1.toFixed(0)))) tgj1 = 0;
    else tgj1 = parseFloat(document.getElementById("total_gaji_jam1").value);
    if(isNaN(parseInt(document.getElementById("total_gaji_jam2").value = gajiku2.toFixed(0)))) tgj2 = 0;
    else tgj2 = parseFloat(document.getElementById("total_gaji_jam2").value);
    if(isNaN(parseInt(document.getElementById("total_gaji_jam1").value = gajiku3.toFixed(0)))) tgj3 = 0;
    else tgj3 = parseFloat(document.getElementById("total_gaji_jam3").value);

    if(isNaN(parseInt(document.getElementById("total_gaji_jam1").value = (gajiku1/qt1).toFixed(0)))) tgo1 = 0;
    else tgo1 = parseFloat(document.getElementById("total_gaji_jam1").value);
    if(isNaN(parseInt(document.getElementById("total_gaji_jam2").value = (gajiku2/qt2).toFixed(0)))) tgo2 = 0;
    else tgo2 = parseFloat(document.getElementById("total_gaji_jam2").value);
    if(isNaN(parseInt(document.getElementById("total_gaji_jam1").value = (gajiku2/qt2).toFixed(0)))) tgo3 = 0;
    else tgo3 = parseFloat(document.getElementById("total_gaji_jam3").value);

    if(isNaN(parseInt(document.getElementById("total_gaji2").value = (gajiku1+gajiku2+gajiku3).toFixed(0)))) tg2 = 0;
    else tg2 = parseFloat(document.getElementById("total_gaji2").value);
    document.getElementById("total_gaji_jam1").value = tgj1;
    document.getElementById("total_gaji_orang1").value = tgo1;
    document.getElementById("total_gaji_jam2").value = tgj2;
    document.getElementById("total_gaji_orang2").value = tgo2;
    document.getElementById("total_gaji_jam3").value = tgj3;
    document.getElementById("total_gaji_orang3").value = tgo3;
    document.getElementById("total_gaji2").value = tg2;
  }
</script>
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>Tambah Proyek</li>
        <li class="active">Tambah Perhitungan Gaji</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" action="hitunggaji_db" method="post">
                <div class="box-body">
                  <?php
                    $sql = mysql_query("SELECT * FROM durasi WHERE id_temp = '$id_proyek'");
                    $result = mysql_fetch_array($sql);
                    $jam = $result['perjam'];
                    $id_durasi = $result['id_durasi'];
                  ?>
                  <div class="col-xs-12">
                  ...
                  <div class="col-xs-12">
                    ...
                    <div class="form-group col-xs-1">
                      <input type="hidden" name="id_gaji" class="form-control" value="<?php $query = mysql_query("SELECT COUNT(*) FROM gaji"); $data = mysql_fetch_array($query); $id_gaji = $data['COUNT(*)']+1; echo $id_gaji; ?>" readonly>
                      <input type="hidden" name="id_durasi" class="form-control" value="<?php echo $id_durasi; ?>" readonly>
                    ...
                    <div class="form-group col-xs-2">
                      ...
                      <input type="hidden" name="total_er_perjam" class="form-control" id="total_er_perjam" value="<?php echo number_format($jam,2,",",""); ?>" readonly>
                    </div>
                    <div class="form-group col-xs-2">
